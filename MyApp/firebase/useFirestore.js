...
import { collection, startAfter, getDocs, limit, query, orderBy, onSnapshot } from "firebase/firestore";
...
const docRef = (Page, lastVisible) => {
    ...
    if (Page <= 1) {
        ...
        myQuery = query(empRef, orderBy("name"), startAfter(lastVisible), limit(5));
    }
    return myQuery;
}
